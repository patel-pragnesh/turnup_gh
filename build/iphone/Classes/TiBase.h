...
// in simulator we redefine to format for TurnUp Developer console
...
{\
	NSString * exceptionName = [@"org.turnup." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.turnup";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITurnUpNativeItemNone = -1, 
	UITurnUpNativeItemSpinner = -2,
	UITurnUpNativeItemProgressBar = -3,
	
	UITurnUpNativeItemSlider = -4,
	UITurnUpNativeItemSwitch = -5,
	UITurnUpNativeItemMultiButton = -6,
	UITurnUpNativeItemSegmented = -7,
	
	UITurnUpNativeItemTextView = -8,
	UITurnUpNativeItemTextField = -9,
	UITurnUpNativeItemSearchBar = -10,
	
	UITurnUpNativeItemPicker = -11,
	UITurnUpNativeItemDatePicker = -12,
	
	UITurnUpNativeItemInfoLight = -13,
	UITurnUpNativeItemInfoDark = -14,
	
	UITurnUpNativeItemDisclosure = -15,
	
	UITurnUpNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TurnUp instances of
