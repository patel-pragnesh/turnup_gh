...
{
	console.log(">>>>>> Refresh Popular List <<<<<<");
	var loaderArgs = {
...
{
	console.log(Alloy.CFG.Urls.baseURL + Alloy.CFG.Urls.getPopularItems + Ti.App.Properties.getString("userId"));
	var loaderArgs = {
		callbackFunction : callBackLoadPopularItems,
		url : Alloy.CFG.Urls.baseURL + Alloy.CFG.Urls.getPopularItems + Ti.App.Properties.getString("userId")
	};
	loader.get(loaderArgs);
};
